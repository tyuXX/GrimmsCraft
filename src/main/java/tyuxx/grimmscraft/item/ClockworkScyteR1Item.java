...
import tyuxx.grimmscraft.procedures.ClockworkScyteR1CraftedSmeltedProcedure;
...
public class ClockworkScyteR1Item extends SwordItem {
	public ClockworkScyteR1Item() {
		super(new Tier() {
			public int getUses() {
				return 120000;
			}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		ClockworkScyteR1CraftedSmeltedProcedure.execute(itemstack);
	}
