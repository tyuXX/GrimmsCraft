...
import tyuxx.grimmscraft.procedures.ClockworkScyteT3CraftedSmeltedProcedure;
...
public class ClockworkScyteT3Item extends SwordItem {
	public ClockworkScyteT3Item() {
		super(new Tier() {
			public int getUses() {
				return 100000;
			}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		ClockworkScyteT3CraftedSmeltedProcedure.execute(itemstack);
	}
