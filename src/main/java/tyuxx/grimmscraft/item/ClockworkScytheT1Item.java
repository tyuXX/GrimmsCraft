...
import tyuxx.grimmscraft.procedures.ClockworkScytheT1ItemIsCraftedsmeltedProcedure;
...
public class ClockworkScytheT1Item extends SwordItem {
	public ClockworkScytheT1Item() {
		super(new Tier() {
			public int getUses() {
				return 97000;
			}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		ClockworkScytheT1ItemIsCraftedsmeltedProcedure.execute(itemstack);
	}
