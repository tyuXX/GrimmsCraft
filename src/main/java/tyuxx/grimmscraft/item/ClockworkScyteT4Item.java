...
import tyuxx.grimmscraft.procedures.ClockworkScyteT4CraftedSmeltedProcedure;
...
public class ClockworkScyteT4Item extends SwordItem {
	public ClockworkScyteT4Item() {
		super(new Tier() {
			public int getUses() {
				return 120000;
			}
	...
	public void onCraftedBy(ItemStack itemstack, Level world, Player entity) {
		...
		ClockworkScyteT4CraftedSmeltedProcedure.execute(itemstack);
	}
