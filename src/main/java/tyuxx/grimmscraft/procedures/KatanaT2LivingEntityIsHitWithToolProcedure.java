...
public class KatanaT2LivingEntityIsHitWithToolProcedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		...
		if (entity instanceof LivingEntity _entity)
			...
			}, (float) (itemstack.getOrCreateTag().getDouble("level") * GrimmscraftModVariables.MapVariables.get(world).katanapow * 2));
		...
		itemstack.getOrCreateTag().putDouble("atp", (itemstack.getOrCreateTag().getDouble("level") * GrimmscraftModVariables.MapVariables.get(world).katanapow * 2));
	}
}
