...
public class GetFEOfBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof Player _player && !_player.level.isClientSide())
			_player.displayClientMessage(Component.literal(("Energy Of Block - " + (new Object() {
			...
			}.getMaxEnergyStored(world, BlockPos.containing(x, y, z))))), true);
	}
}
