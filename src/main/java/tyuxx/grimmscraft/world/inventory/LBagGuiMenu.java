...
public class LBagGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LBagGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GrimmscraftModMenus.L_BAG_GUI.get(), id);
