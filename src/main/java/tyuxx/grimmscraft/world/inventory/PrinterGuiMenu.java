...
public class PrinterGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PrinterGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(GrimmscraftModMenus.PRINTER_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 61, 26) {
			...
			public boolean mayPlace(ItemStack stack) {
				return GrimmscraftModItems.PRINTER_CARTRIDGE.get() == stack.getItem();
			}
		}));
