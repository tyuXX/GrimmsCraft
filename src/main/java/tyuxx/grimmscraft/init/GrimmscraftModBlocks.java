...
public class GrimmscraftModBlocks {
	...
	public static final RegistryObject<Block> EMERALD_GENERATOR = REGISTRY.register("emerald_generator", () -> new EmeraldGeneratorBlock());
	...
	public static final RegistryObject<Block> DIAMOND_GENERATOR = REGISTRY.register("diamond_generator", () -> new DiamondGeneratorBlock());
	public static final RegistryObject<Block> COAL_GENERATOR = REGISTRY.register("coal_generator", () -> new CoalGeneratorBlock());
	public static final RegistryObject<Block> GOLD_GENERATOR = REGISTRY.register("gold_generator", () -> new GoldGeneratorBlock());
	public static final RegistryObject<Block> LAPIS_LAZULI_GENERATOR = REGISTRY.register("lapis_lazuli_generator", () -> new LapisLazuliGeneratorBlock());
	public static final RegistryObject<Block> QUARTZ_GENERATOR = REGISTRY.register("quartz_generator", () -> new QuartzGeneratorBlock());
	public static final RegistryObject<Block> COPPER_GENERATOR = REGISTRY.register("copper_generator", () -> new CopperGeneratorBlock());
}
