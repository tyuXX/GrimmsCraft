...
public class SolarPanelT1BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public SolarPanelT1BlockEntity(BlockPos position, BlockState state) {
		super(GrimmscraftModBlockEntities.SOLAR_PANEL_T_1.get(), position, state);
	}
	...
	public Component getDisplayName() {
		return Component.literal("Solar Panel T 1");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(25000, 0, 125, 0) {
		@Override
